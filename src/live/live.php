...
<head>
	...
	<script type="text/javaScript" src="http://ape-test.local/public/Ape/Clients/mootools-core.js"></script>
	<script type="text/javaScript" src="http://ape-test.local/public/Ape/Clients/MooTools.js"></script>
	<script type="text/javaScript" src="http://ape-test.local/public/Ape/Demos/config.js"></script>
	...
	<script type="text/javaScript">
		window.addEvent('domready', function(){
			...
			client.load({
				identifier: 'action',
				channel: 'court' + <?php echo $_GET['court']; ?> 
			});
		});
	</script>
</head>
