...
class Main
{
	...
	public function displayColright()
	{
		...
		$links = array(
		array("EasyBadNet v2.8r1", "http://www.badnet.org/download/easybadnet_v2.8r1.exe"),
		...
		array('Notes de version', "http://www.badnet.org/pmwiki/pmwiki.php?n=Logiciel.NotesDeVersions"),
...
//$this->testDb();
		...
		if ( ! count($events))
		{
			...
			$q->addWhere("evnt_lastday >'" . date('Y-d-m H:i:s') . "'");
			$res = $q->getCol();
