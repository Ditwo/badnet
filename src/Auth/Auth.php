...
class Auth {
    ...
    function setAuth($username)
    {
        ...
        $this->session['sessionurl'] = isset($this->server['PHP_SELF'])
            ? $this->server['PHP_SELF']
            : '';
    ...
    function checkAuth()
    {
        ...
        if (isset($this->session)) {
            ...
            if ( isset($this->server['PHP_SELF']) 
                && isset($this->session['sessionurl'])
                && $this->session['sessionurl'] != $this->server['PHP_SELF']) {
                $this->log('Security url. Url changed.', AUTH_LOG_INFO);
                // Check if the url has changed, if so we
