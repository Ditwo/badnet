...
class Auth_Container_PDO extends Auth_Container
{
	...
	// }}}
	// {{{ Auth_Container_PDO [constructor]
...
//echo "<br>---------------------$dsn---------------------<br>";
		...
		{
			try {
				$this->db = new PDO($dsn, $this->options['db_login'], $this->options['db_pwd'], $this->options['db_options']);
			} catch (PDOException $e) {
				echo $e->getMessage();
				return PEAR::raiseError('Auth::Pdo->connect: Connexion échouée : ' . $e->getMessage());
			}
		}
	...
	function _setDefaults()
	{
		...
		$this->options['db_login']    = '';
		$this->options['db_pwd']      = '';
		$this->options['auto_quote']  = false;
	}
	...
	function fetchData($username, $password, $isChallengeResponse=false)
	{
		...
		$query = "SELECT ".$sql_from.
                ...
                " WHERE ".$this->options['final_usernamecol']." = ".$this->db->quote($username);
		...
		if ($st === False) {
			...
			return PEAR::raiseError($err[2], $err[0]);
		}
